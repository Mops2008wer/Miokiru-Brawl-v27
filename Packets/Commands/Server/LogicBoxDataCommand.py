    ...
    def encode(self):
        ...
        def get_id(id):
            if id == 5:  # Brawl Box         
                ...
                DataBase.replaceValue(self, 'PassRewards', self.player.pass_rewards + 1)
                return 10
            elif id == 10:  # Brawl Pass Big Box
                if self.player.pass_rewards >= 62:
                    DataBase.replaceValue(self, 'BrawlBoxes', self.player.brawl_boxes - 500)
                    print(1)
                else:
                    print(self.player.pass_rewards)
                    i = self.player.pass_rewards
                    i = i + 1
                    print(i)
                    DataBase.replaceValue(self, 'PassRewards', i)
                    print(self.player.pass_rewards)
                return 12
